...
typedef enum VkPerformanceCounterUnitKHR {
  ...
  VK_PERFORMANCE_COUNTER_UNIT_BEGIN_RANGE_KHR =
      VK_PERFORMANCE_COUNTER_UNIT_GENERIC_KHR,
  VK_PERFORMANCE_COUNTER_UNIT_END_RANGE_KHR =
      VK_PERFORMANCE_COUNTER_UNIT_CYCLES_KHR,
  VK_PERFORMANCE_COUNTER_UNIT_RANGE_SIZE_KHR =
      (VK_PERFORMANCE_COUNTER_UNIT_CYCLES_KHR -
       VK_PERFORMANCE_COUNTER_UNIT_GENERIC_KHR + 1),
...
typedef enum VkPerformanceCounterScopeKHR {
  ...
  VK_PERFORMANCE_COUNTER_SCOPE_BEGIN_RANGE_KHR =
      VK_QUERY_SCOPE_COMMAND_BUFFER_KHR,
  VK_PERFORMANCE_COUNTER_SCOPE_END_RANGE_KHR = VK_QUERY_SCOPE_COMMAND_KHR,
  VK_PERFORMANCE_COUNTER_SCOPE_RANGE_SIZE_KHR =
      (VK_QUERY_SCOPE_COMMAND_KHR - VK_QUERY_SCOPE_COMMAND_BUFFER_KHR + 1),
...
typedef enum VkPerformanceCounterStorageKHR {
  ...
  VK_PERFORMANCE_COUNTER_STORAGE_BEGIN_RANGE_KHR =
  ...
  VK_PERFORMANCE_COUNTER_STORAGE_RANGE_SIZE_KHR =
      (VK_PERFORMANCE_COUNTER_STORAGE_FLOAT64_KHR -
       VK_PERFORMANCE_COUNTER_STORAGE_INT32_KHR + 1),
...
typedef enum VkDriverIdKHR {
  ...
  VK_DRIVER_ID_RANGE_SIZE_KHR = (VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR -
                                 VK_DRIVER_ID_AMD_PROPRIETARY_KHR + 1),
...
typedef enum VkSemaphoreTypeKHR {
  ...
  VK_SEMAPHORE_TYPE_RANGE_SIZE_KHR =
      (VK_SEMAPHORE_TYPE_TIMELINE_KHR - VK_SEMAPHORE_TYPE_BINARY_KHR + 1),
...
typedef VkDeviceAddress(VKAPI_PTR* PFN_vkGetBufferDeviceAddressKHR)(
    VkDevice device, const VkBufferDeviceAddressInfoKHR* pInfo);
...
typedef uint64_t(VKAPI_PTR* PFN_vkGetDeviceMemoryOpaqueCaptureAddressKHR)(
    VkDevice device, const VkDeviceMemoryOpaqueCaptureAddressInfoKHR* pInfo);
...
typedef enum VkGeometryTypeNV {
  ...
  VK_GEOMETRY_TYPE_RANGE_SIZE_NV =
      (VK_GEOMETRY_TYPE_AABBS_NV - VK_GEOMETRY_TYPE_TRIANGLES_NV + 1),
